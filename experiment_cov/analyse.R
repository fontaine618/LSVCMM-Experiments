...
write.csv(estimates, file="./experiment_cov/estimates.csv", row.names=F)
write.csv(estimation_errors, file="./experiment_cov/estimation_errors.csv", row.names=F)
write.csv(classifications, file="./experiment_cov/classifications.csv", row.names=F)
# ------------------------------------------------------------------------------
