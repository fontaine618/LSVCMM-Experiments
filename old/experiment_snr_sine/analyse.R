...
DIR = "./experiment_snr_sine/registry/"
...
write.csv(estimates, file="./experiment_snr_sine/estimates.csv", row.names=F)
write.csv(estimation_errors, file="./experiment_snr_sine/estimation_errors.csv", row.names=F)
write.csv(classifications, file="./experiment_snr_sine/classifications.csv", row.names=F)
write.csv(parameters, file="./experiment_snr_sine/parameters.csv", row.names=F)
...
write.csv(settings, file="./experiment_snr_sine/settings.csv", row.names=F)
# ------------------------------------------------------------------------------
...
write.csv(icresults, file="./experiment_snr_sine/icresults.csv", row.names=F)
# ------------------------------------------------------------------------------
