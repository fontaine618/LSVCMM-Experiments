...
DIR = "./experiment_missing_sine/registry/"
...
write.csv(estimates, file="./experiment_missing_sine/estimates.csv", row.names=F)
write.csv(estimation_errors, file="./experiment_missing_sine/estimation_errors.csv", row.names=F)
write.csv(classifications, file="./experiment_missing_sine/classifications.csv", row.names=F)
write.csv(parameters, file="./experiment_missing_sine/parameters.csv", row.names=F)
...
write.csv(icresults, file="./experiment_missing_sine/icresults.csv", row.names=F)
# ------------------------------------------------------------------------------
