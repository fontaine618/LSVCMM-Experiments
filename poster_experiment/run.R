...
DIR = "./poster_experiment/batchtools2/"
...
synthetic = function(data, job, ...){
  return(LSVCMM::generate_synthetic_data(...))
}
...
# ==============================================================================
# Setup algorithms
source("./poster_experiment/algorithms.R")
addAlgorithm(
  name="LSVCMM",
  fun=lsvcmm
)
...
addAlgorithm(
  name="Lasso",
  fun=lsvcmm_independent_cs
)
addAlgorithm(
  name="SPFDA",
  fun=spfda
)
export[["LSVCMM"]] = lsvcmm
export[["Independent"]] = lsvcmm_independent
export[["Cross-sectional"]] = cross_sectional
export[["Lasso"]] = lsvcmm_independent_cs
export[["SPFDA"]] = spfda
# ------------------------------------------------------------------------------
